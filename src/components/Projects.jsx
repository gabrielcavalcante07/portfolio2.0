export function Projects(props){
    return(
        <div className='w-72 min-h-80 mt-12 bg-zinc-900 text-white p-[2px] bg-gradient-to-b from-primary to-indigo-600 rounded-2xl overflow-hidden hover:scale-105 transition-transform duration-500'>
            <div className="h-full pb-5 flex flex-col justify-center items-center bg-zinc-900 rounded-2xl text-white">
                <img src={props.img} className='w-full h-40 object-cover rounded-2xl p-2' alt="" />
